...
from app.models import BaseNode, BaseEdge, Judgment, ReasoningTrace, HasStepEdge, InformedByEdge
from app.retrieval_policies import RETRIEVAL_POLICIES

# ─── Schema maps (loaded once at import) ──────────────────────────────────────

def _load_schema() -> dict:
    # backend/app/ → repo-root schema/ (shared source of truth)

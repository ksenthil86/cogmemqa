...
def test_models_import_cleanly():
    from app.agents.models import ParsedActor, ParsedAC, ParsedRequirement, ParsedSpec
...
def test_parsed_actor_valid():
    from app.agents.models import ParsedActor
...
def test_parsed_ac_valid():
    from app.agents.models import ParsedAC
...
def test_parsed_requirement_valid():
    from app.agents.models import ParsedAC, ParsedRequirement
...
def test_parsed_requirement_reg_control_optional():
    from app.agents.models import ParsedRequirement
    req = ParsedRequirement(
        id="req-x",
        title="X",
        priority="P1",
...
def test_parsed_spec_valid():
    from app.agents.models import ParsedAC, ParsedActor, ParsedRequirement, ParsedSpec
    spec = ParsedSpec(
...
def test_meridian_parsed_json_loads_as_parsed_spec():
    from app.agents.models import ParsedSpec

...
- [x] Task 1: Create `backend/` and move the package with history (P0)
...
- [x] Task 2: Import sweep `src.` → `app.` inside the package (P0)
...
- [x] Task 3: Move + adapt `pyproject.toml` (P0)
...
- [x] Task 4: Move tests + fix conftest/env paths + import sweep (P0)
...
- [x] Task 5: Move scripts + fixtures + fix resource paths (P0)
...
- [x] Task 8: End-to-end verification (P0)
...
- [x] Task 9: Sweep stale references + walkthrough (P1)
...
- [x] Task 10: Commit with clean rename detection (P2)

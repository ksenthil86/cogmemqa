...
def test_func_to_endpoint_map_has_all_five():
    from app.agents.functional_tester import _FUNC_TO_ENDPOINT
...
def seed_t3_nodes(neo4j_driver):
    ...
    from app.models import Test, Functionality, VerifiesEdge
...
def seed_t4_nodes(neo4j_driver):
    ...
    from datetime import datetime, timezone
    from app.memory_api import ingest_node, ingest_edge
    from app.models import Test, AcceptanceCriterion, Functionality, CoversCriterionEdge, VerifiesEdge
...
def seed_t5_nodes(neo4j_driver):
    ...
    from app.memory_api import ingest_node
